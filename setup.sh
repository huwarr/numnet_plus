...
if [ ${TMSPAN} = tag_mspan ]; then
    ...
    python3 drop_eval.py --gold_path drop_dataset/drop_dataset_dev.json --prediction_path numnet_plus_345_LR_5e-4_BLR_1.5e-5_WD_5e-5_BWD_0.01tag_mspan/dev.json
# Simple multi-span extraction -- NumNet+
    ...
    python3 drop_eval.py --gold_path drop_dataset/drop_dataset_dev.json --prediction_path numnet_plus_345_LR_5e-4_BLR_1.5e-5_WD_5e-5_BWD_0.01/dev.json
fi